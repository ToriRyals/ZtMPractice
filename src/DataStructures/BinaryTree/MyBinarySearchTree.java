...
public class MyBinarySearchTree {
    ...
    public void insert(int value) {
        ...
        while (true) {
            if (currentNode.getValue() > value) { //value less than the root
                if(currentNode.getLeft() == null) {
                    currentNode.setLeft(new MyBinaryNode(value));
                    return;
                }
                currentNode = currentNode.getLeft();
            } else { //value is greater than the root
    ...
    public MyBinaryNode lookup(int value) {
        ...
        while (currentNode != null) {
            if(currentNode.getValue() > value) { //value is less than root
                currentNode = currentNode.getLeft();
            } else if(currentNode.getValue() < value) { //value is greater than root
                currentNode = currentNode.getRight();
            } else {
                return currentNode;
            }
    ...
    public void remove(int value) {
        ...
        while (nodeToRemove.getValue() != value) { //Searching for the node to remove and it's parent
            ...
            if (nodeToRemove.getValue() > value) { //node to remove is greater than value
                nodeToRemove = nodeToRemove.getLeft();
            } else if (nodeToRemove.getValue() < value) {//node to remove is less than value
